...
public class WelcomePageObject extends MainPageObject {
    ...
    public static final String
            ...
            STEP_ADD_OR_EDIT_PREFFERED_LANT_LINK = "id:Add or edit preferred languages",
    ...
    public void waitForAddOrEditPrefferedLangText() {
        this.waitForElementPresent(STEP_ADD_OR_EDIT_PREFFERED_LANT_LINK, "Cannot find 'Add or edit preferred languages' link", 10);
    }
